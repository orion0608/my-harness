...
|-------------|-------------------|---------|
| `frontend-design` | `brainstorming-visual-enhancement` 规则 | UI 场景按 `design.md`「前端设计」读取该技能并路由 style/frame/动效 |
...
| `doc-file-definition-design`（前端设计表） | `frontend-design` 技能 | 动效强度 / 动画库为动效路由输入；「前端设计」整表由流程注入上下文 |
